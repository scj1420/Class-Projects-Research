...
//        con.setRequestProperty("Authorization", "12345");
     ...
     */
    RegisterResult register(RegisterRequest r) throws IOException {
     ...
     */
    PersonResult person(String personID, String token) throws IOException {
     ...
     */
    PeopleResult person(String token) throws IOException {
     ...
     */
    LoginResult login(LoginRequest r) throws IOException {
        Encoder encoder = new Encoder();
        String serialized  = encoder.Encode(r);
     ...
     */
    LoadResult load(LoadRequest r) throws IOException {
        Encoder encoder = new Encoder();
        String serialized  = encoder.Encode(r);
     ...
     */
    FillResult fill(String userName,
    ...
    FillResult fill(String userName) throws IOException{
     ...
     */
    EventResult event(String eventID, String token) throws IOException {
     ...
     * @return
     */
    EventsResult event(String token) throws IOException {
     ...
     */
    ClearResult clear() throws IOException{
