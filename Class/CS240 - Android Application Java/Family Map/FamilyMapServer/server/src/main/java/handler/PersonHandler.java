...
public class PersonHandler implements HttpHandler {
    private PersonResult result1;
    private PeopleResult result2;
                ...
                if (reqHeaders.containsKey("Authorization")) {
                    ...
                    if (token.equals(authToken.getAuthToken())) {
                        ...
                        if (list.size() == 3) {
                            ...
                            try {
                                result1 = ps.person(list.get(2), authToken.getUser());
                            } catch (DatabaseException e) {
                                result1 = new PersonResult();
                            ...
                            PersonService ps = new PersonService();
                            try {
                                result2 = ps.persons(authToken.getUser());
                            } catch (DatabaseException e) {
                                result2 = new PeopleResult();
