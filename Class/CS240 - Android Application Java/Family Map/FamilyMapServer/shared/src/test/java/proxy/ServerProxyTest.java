...
public class ServerProxyTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        LoginRequest lr = new LoginRequest("scj14", "ko-ng3513");
        LoginResult result2 = sp.login(lr);
        token = new AuthToken(result2.getSrb().getAuthToken(), result2.getSrb().getPersonID());
        personID = result2.getSrb().getPersonID();
    }
    ...
    public void testPerson() throws Exception {
        sp.person(token.getAuthToken());
    }

    public void testPerson1() throws Exception {
        sp.person(personID, token.getAuthToken());
    }
    ...
    public void testEvent() throws Exception {
        sp.event(token.getAuthToken());
    }

    public void testEvent1() throws Exception {
        sp.event("cbe3c1c7-2ef7-4ff9-94b3-70a0d05e82cd", token.getAuthToken());
    }
